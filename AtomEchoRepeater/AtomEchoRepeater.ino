...
uint8_t microphonedata0[NUM_BUF*BUF_SIZE];
int data_offset = 0;
...
void loop() 
{
    if (M5.Btn.isPressed())
    {
        ...
        for (int i=0; i<80; i++)
        {
            i2s_read(SPEAKER_I2S_NUMBER, (char *)(microphonedata0 + data_offset), BUF_SIZE, &byte_read, (100 / portTICK_RATE_MS));
